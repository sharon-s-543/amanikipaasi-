...
INSERT INTO quiz VALUES(2,'How to change a adjective to an adverb?','Add the suffix "-asimur".','Change the article to abstract.','Add the prefix "im-".','Add the suffix "-giri" or "-agiri".','D');
INSERT INTO quiz VALUES(3,'Which of the following sentences is correct?','Ama thiki baash.','Ni mia alsjami.','Bi paasharr''nil ami.','Dhi chessilija''nil puthumi.','C');
INSERT INTO quiz VALUES(4,'What does the word "ilija''n" mean?','to play','a player ','a game','a joke','B');
INSERT INTO quiz VALUES(5,'What does "paasharrmi" mean?','to treat','a nurse','a doctor','to feed','A');
INSERT INTO quiz VALUES(6,'"Ama niki kith." What is wrong with this sentence?','Possessed is not in accusative case.','Wrong vowel duration in "ama".','Indefinite article is not used.','Possessed does not have suffix "-i".','D');
INSERT INTO quiz VALUES(7,'What is the definite article for abstract nouns?','oom','o','eim','ai','C');
INSERT INTO quiz VALUES(8,'What is the correct suffix for indirect objects?','"-iki"','"-asimur"','"-oom"','"-ruupe"','D');
INSERT INTO quiz VALUES(9,'Among them, what is the correct suffix for essive case?','"-goom"','"-upami"','"-il"','Essive case doesn''t exist in Amanikipaasi.','A');
INSERT INTO quiz VALUES(10,'How do you conjugate the verb for "you" in simple future?','You add "-rr''nu" without dropping the ending "-mi".','There is no conjugation for simple future.','You add "-rr''nu" after dropping the ending "-mi".','You add "-rr''nam" after dropping the ending "-mi".','B');
INSERT INTO quiz VALUES(11,'What does the word "dhoohamirrmam" mean?','far away','a portal','a train','an airplane ','B');
PRAGMA writable_schema=ON;
CREATE TABLE IF NOT EXISTS sqlite_sequence(name,seq);
DELETE FROM sqlite_sequence;
INSERT INTO sqlite_sequence VALUES('lessons',6);
INSERT INTO sqlite_sequence VALUES('phrases',10);
INSERT INTO sqlite_sequence VALUES('quiz',11);
INSERT INTO sqlite_sequence VALUES('dictionary',34);
